...
import com.bloomhousemc.terrafabricraft.common.component.*;
import net.minecraft.entity.LivingEntity;
import net.minecraft.entity.player.PlayerEntity;
import net.minecraft.util.Identifier;

public final class TfcComponents implements EntityComponentInitializer, WorldComponentInitializer, ItemComponentInitializer {
