...
public class TFCScreens {
    ...
    public static void init() {
        ...
        //CERAMIC_VESSEL_SCREEN_HANDLER = ScreenHandlerRegistry.registerSimple(new Identifier(MODID, "vessel"), (syncId, inventory) -> new CeramicVesselScreenHandler(syncId, inventory, ScreenHandlerContext.EMPTY));
