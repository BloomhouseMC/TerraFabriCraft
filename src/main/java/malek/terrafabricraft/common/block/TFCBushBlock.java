...
public class TFCBushBlock extends PlantBlock implements Fertilizable {
    public IntProperty AGE;
    private final VoxelShape SHAPE;

    private final Item berry;
    private final int maxAge;

    public TFCBushBlock(Item berry, VoxelShape shape, int maxAge, Settings settings) {
        super(settings);
